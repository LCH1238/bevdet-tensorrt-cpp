...
public:
    PreprocessPlugin() = delete;
    PreprocessPlugin(const std::string &name, int crop_h, int crop_w, float resize_radio);
    PreprocessPlugin(const std::string &name, const void *buffer, size_t length);
    ~PreprocessPlugin();
