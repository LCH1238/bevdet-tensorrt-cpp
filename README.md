...
**NEWS** : A new branch "one" has been released. This branch implements TensorRT-plugins. [bevdet-tensorrt-cpp](https://github.com/LCH1238/bevdet-tensorrt-cpp/tree/one)
